...
import './UiAbout.css';
import uiux from '../Carousel_Images/ui-ux-2.avif';
        ...
        <div id="about" className="uiux-container">
            ...
            <div className="uiux-about">
                ...
                <div className="uiux-about-content">
                    <h2>UI/UX Designing Beginners Course Overview</h2>
                    <h3>A UI/UX design course for beginners can teach you the principles and skills needed to create user-friendly digital products. Some topics you may learn in a UI/UX design course include:</h3>
